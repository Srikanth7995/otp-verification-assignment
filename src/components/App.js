  ...
  render() {
    ...
    return (
      <div>
              ...
              <Col className="mycolumn midcolumn" lg={6}>
                <div className="innerdiv">
                  <div id="mainimage-container">
                    <img src="https://eliveclass.com/wp-content/uploads/2021/06/AdmitKard-Logo-2048x385.png" className="headimage" alt="App heading" />
                  </div>
        ...
        {askOtp && <Otp phoneNumber={fullNumber} />}
      </div>
    );
  }
}
